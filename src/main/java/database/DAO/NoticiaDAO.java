...
public class NoticiaDAO implements INoticiaDAO{
    ...
    private final String stmtListarNoticiasUsuario = "SELECT * FROM NOTICIA WHERE " + colidusuario + " = ?";
    ...
    public void removerNoticia(int idNoticia) throws Exception {
        try {     
            ...
            //remove todos comentarios da noticia
            ComentarioDAO comentarioDAO = new ComentarioDAO();
            List<Comentario> comentarios = comentarioDAO.listarComentariosNoticia(idNoticia);
    ...
    List<Noticia> listarNoticiasUsuario(int idUsuario) throws Exception {
        try {
            List<Noticia> noticias = new ArrayList<>();            
            
            con = new ConnectionFactory().getConnection();
            stmt = con.prepareStatement(stmtListarNoticiasUsuario);
