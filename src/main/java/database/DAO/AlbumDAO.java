...
public class AlbumDAO implements IAlbumDAO{
    ...
    public void removerAlbum(int idAlbum) throws Exception {
        try {     
            ...
            //remove todas fotos do album
            FotoDAO fotoDAO = new FotoDAO();
            List<Foto> fotosAlbum = fotoDAO.listarFotosAlbum(idAlbum);
            for (int i = 0 ; i < fotosAlbum.size() ; i++)
                fotoDAO.removerFoto(fotosAlbum.get(i).getIdFoto());
